...
public class Example {
    public static void menu(){
     ...
     public static String[]  addNewStudentWithMarks(){
       lebal:while(true){        
              ...
              //if id don't get duplicated system letb user to enter the current student details:)
     ...
     public static void addMarks(){
      ...
      Scanner scanner=new Scanner(System.in);
         if(Studentid.length<0){
            System.out.println("invalid --->");//bif user did't add some
            return;
         }else{
        prob1:while(true){
              System.out.print("Enter Student ID :"); 
  ...
  lebal :while(true){
    ...
    public static void printStudentDetails(){
      if(Studentid.length==0){
        System.out.println("Plaese enter detalis.");
            return;
      }
      Scanner scanner=new Scanner(System.in); 
      double avg[]=Ranks();
    ...
    public static void pfundermentals() {
      ...
      while(true){
         ...
         int temp3,temp4;
          ...
          System.out.println("+-------+---------------------------------------+---------------+---------------+---------+");
          System.out.print("\n\n\n\n\n\nDo you want to go back the Main menu:");
          char c=scanner.next().charAt(0);
          clearConsole();
             if(c=='y' || c=='Y'){
                 return;
